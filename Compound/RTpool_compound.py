...
def main():
    ...
    graphs_main = TUDataset(root='/tmp/' + args.dataset, name=args.dataset)
    graphs = [MyData(index=i, **data) for i, data in enumerate(graphs_main)]

    num_classes = graphs_main.num_classes
